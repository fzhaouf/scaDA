...
#' @param contrl.loc cell type of interest
#' @param case.loc cell type of interest
#'
...
estParams2 <- function(object, contrl.loc,case.loc){
  ...
  celltype1.loc = contrl.loc  # assuming c1 is reference
  celltype2.loc = case.loc  # assuming c2 is case
